...
<head>
  ...
  <script src="../Js/verSolicitudesDescargar.js" type="text/javascript"></script>
                  ...
                  <div id="descargarActas" class="tab-pane active">
                    <div class="row">
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        <h4 class="mb">Descargar actas del usuario <?php echo$_SESSION["saludo"];?></h4>
						<table id="canio">
							...
							<table align="center" border="1" id="tablaDescargarActas"  cellpadding="1"style=" background: #CCCCCC;">
								<thead>
									<tr>
										...
										<td style="background-color: #58D3F7"><font color='#000000'><strong><i class=" fa fa-download"></i>Descargar</strong></font></td>
									</tr>
								</thead>
								<tbody> 
										<td></td>
