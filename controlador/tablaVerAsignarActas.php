...
$anio = trim($_GET['anio']);
		...
		$select = "   s.idsolicitud, 
			...
			$where = " eliminada = false AND solicerrada='false' AND s.anosolicitud = $anio ";
 ...
 */
echo $objSolicitud->generarJsonVerSolicitudAsignarActas($comp[0], $comp[1], $comp[2], $comp[3]);
