...
$anio = trim($_GET['anio']);
			...
			$where = " eliminada = false AND solicerrada=true AND idusuario = $idusuario AND s.anosolicitud = $anio ";
 ...
 */
echo $objSolicitud->generarJsonVerSolicitudDescargarActas($comp[0], $comp[1], $comp[2], $comp[3]);
